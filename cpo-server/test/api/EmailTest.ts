  ...
  describe('Email', () => {
    ...
    it('new-registered-user', async () => {
      const data: NewRegisteredUserNotification = {
        ...
        user,
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseDashboardVerifyEmailURL: BrandingConstants.WATTZHUB_CPO_URL,
      };
    ...
    it('request-password', async () => {
      const data: RequestPasswordNotification = {
        user,
        evseDashboardResetPassURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL
      };
    ...
    it('optimal-charge-reached', async () => {
      const data: OptimalChargeReachedNotification = {
        ...
        stateOfCharge: 89,
        evseDashboardChargingStationURL: BrandingConstants.WATTZHUB_CPO_URL,
        user,
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
      };
    ...
    it('billing-new-invoice-paid', async () => {
      const data: BillingNewInvoiceNotification = {
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseDashboardInvoiceURL: BrandingConstants.WATTZHUB_CPO_URL,
        user,
        invoiceDownloadUrl: BrandingConstants.WATTZHUB_CPO_URL,
        payInvoiceUrl: BrandingConstants.WATTZHUB_CPO_URL,
    ...
    it('billing-account-created', async () => {
      const data: BillingAccountCreationLinkNotification = {
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        user,
        onboardingLink: BrandingConstants.WATTZHUB_CPO_URL,
      };
    ...
    it('billing-user-synchronization-failed', async () => {
      const data: BillingUserSynchronizationFailedNotification = {
        nbrUsersInError: 123,
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseDashboardBillingURL: BrandingConstants.WATTZHUB_CPO_URL,
      };
    ...
    it('admin-account-verification-notification', async () => {
      const data: AdminAccountVerificationNotification = {
        user,
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseUserToVerifyURL: BrandingConstants.WATTZHUB_CPO_URL,
      };
    ...
    it('user-create-password', async () => {
      const data: UserCreatePassword = {
        ...
        evseDashboardURL: BrandingConstants.WATTZHUB_CPO_URL,
        evseDashboardCreatePasswordURL: BrandingConstants.WATTZHUB_CPO_URL,
      };
