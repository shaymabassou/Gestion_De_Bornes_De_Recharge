...
import SchneiderTestAssetIntegration from './schneider/SchneiderTestAssetIntegration';
        ...
        if (foundConnection) {
          ...
          switch (foundConnection.type) {
            case AssetConnectionType.SCHNEIDER:
              ...
              break;
            case AssetConnectionType.SCHNEIDER_TEST:
              console.log('-------------------------------------im here 3');
              assetIntegrationImpl = new SchneiderTestAssetIntegration(tenant, settings.asset, foundConnection);
              break;
