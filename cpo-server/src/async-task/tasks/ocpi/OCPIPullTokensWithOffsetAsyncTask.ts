...
export default class OCPIPullTokensWithOffsetAsyncTask extends AbstractAsyncTask {
      ...
      try {
        ...
        if (pullTokensLock) {
          try {
            ...
            await ocpiClient.pullTokensWithOffSet(false,parseFloat(this.getAsyncTask().parameters.offset));
          } finally {
            // Release the lock
