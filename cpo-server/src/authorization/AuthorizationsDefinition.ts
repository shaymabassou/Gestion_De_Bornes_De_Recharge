...
export const AUTHORIZATION_DEFINITION: AuthorizationDefinition = {
  ...
  admin: {
    grants: [
      ...
      {
        resource: Entity.EMAID, action: [Action.CREATE, Action.LIST],
        attributes: [
          'id', 'userID', 'active',  'description', 'visualID', 
      ...
      { resource: Entity.EMAID, action: [Action.IMPORT, Action.EXPORT] },
      {
        resource: Entity.EMAID, action: Action.READ,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
        ...
        attributes: [
          'id', 'userID', 'issuer', 'active', 'description', 'visualID',  'user.id',
          'user.name', 'user.firstName', 'user.email'
        ]
      },
//POUR LE CERTIFICATE
      {
        resource: Entity.CERTIFICATE, action: [Action.READ, Action.LIST],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
        ...
        attributes: [
          'id', 'certificateChain', 'hashData', 'certificateType', 'createdAt', 'expiresAt', 'status', 'chargingStationID',
          'tenantID', 'companyID'
        ]
      },
      ...
      {
        resource: Entity.CERTIFICATE, action: Action.LIST,
        attributes: [
          'id', 'certificateChain', 'hashData', 'certificateType', 'createdAt', 'expiresAt', 'status', 'chargingStationID',
          'tenantID', 'companyID'
        ]
      ...
      {
        resource: Entity.CERTIFICATE, action: Action.DELETE,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
      ...
      {
        resource: Entity.EMAID, action: [Action.UPDATE, Action.DELETE],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
...
//
      {
        ...
        attributes: [
          'id', 'userID', 'active', 'ocpiToken', 'description', 'visualID', 'issuer', 'default','fromEMSP',
          'user.name', 'user.firstName', 'user.email', 'createdOn', 'lastChangedOn',
        ]
      },
      { resource: Entity.TAG, action: [Action.IMPORT, Action.EXPORT] },
      {
        ...
        attributes: [
          'id', 'userID', 'issuer', 'active', 'description', 'visualID', 'default', 'user.id','fromEMSP',
          'user.name', 'user.firstName', 'user.email'
        ]
      },
      {
      ...
      {
        resource: Entity.TAG, action: Action.LIST_BAGDES_EMSPS,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
        ...
        attributes: [
          'id', 'issuer', 'active', 'visualID', 'ocpiToken.issuer'
        ]
      ...
      },
      {
        ...
        attributes: [
          ...
          'autoUserSiteAssignment', 'distanceMeters', 'public', 'createdOn', 'lastChangedOn', 'tariffID' , 'tariffIDs'
        ]
      },
      {
      ...
      },
      {
        ...
        attributes: [
          ...
          'address.address1', 'address.address2', 'address.postalCode', 'address.city',
          'address.department', 'address.region', 'address.country', 'address.coordinates','tariffIDs'
        ]
      },
      {
        resource: Entity.SITE_AREA,
      ...
      },
      {
        ...
        attributes: [
          ...
          'connectors.user.id', 'connectors.user.name', 'connectors.user.firstName', 'connectors.user.email','connectors.isPrivate','connectors.ownerIds',
      ...
      },
      {
        ...
        action: [
          ...
          Action.UPDATE_CHARGING_PROFILE, Action.GET_CONNECTOR_QR_CODE, Action.MAINTAIN_PRICING_DEFINITIONS ,Action.ASSIGN_UNASSIGN_USER_TO_CHARGING_STATION_CONNECTOR
        ],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
      ...
      },
      {
        resource: Entity.CHARGING_STATION,
        action: [
          Action.CREATE, Action.READ, Action.REMOTE_START_TRANSACTION, Action.REMOTE_STOP_TRANSACTION, Action.UNLOCK_CONNECTOR, Action.EXPORT, Action.RESERVE_NOW, Action.ASSIGN_UNASSIGN_USERS_TO_CONNECTOR
        ]
      },
      {
        resource: Entity.CHARGING_STATION,
      ...
      {
        resource: Entity.CONNECTOR,
        action: [Action.REMOTE_STOP_TRANSACTION, Action.REMOTE_START_TRANSACTION,Action.ASSIGN_UNASSIGN_USERS_TO_CONNECTOR],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
      ...
      },
      {
        ...
        attributes: [
          ...
          'userID', 'user.id', 'user.email', 'user.firstName', 'user.name', 'pricingModel','tariffData'
        ]
      },
      {
        ...
        attributes: [
          ...
          'userID', 'user.id', 'user.email', 'user.firstName', 'user.name','tag.ocpiToken.issuer','ocpiData.session.authorization_id'
        ]
      },
      {
      ...
      {
        resource: Entity.CHARGING_STATION, action: Action.EXPORT_OCPI_CDR,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
      ...
      { resource: Entity.PRICING, action: [Action.READ, Action.UPDATE] },
      {
        ...
        attributes: [
          ...
          'dimensions.parkingTime.active', 'dimensions.parkingTime.price', 'dimensions.parkingTime.stepSize', 'dimensions.parkingTime.pricedData','roaming'
        ]
      },
      {
      ...
      { resource: Entity.REGISTRATION_TOKEN, action: [Action.DELETE, Action.REVOKE] },
      {
        ...
        attributes: [
          ...
          'createdBy.name', 'createdBy.firstName', 'lastChangedBy.name', 'lastChangedBy.firstName','default'
        ]
      },
      {
        ...
        attributes: [
          ...
          'patchJobResult.successNbr', 'patchJobResult.failureNbr', 'patchJobResult.totalNbr','default'
        ]
      },
      {
    ...
    grants: [
      ...
      },
      {
        ...
        attributes: [
          ...
          'connectors.user.id', 'connectors.user.name', 'connectors.user.firstName', 'connectors.user.email', 'connectors.currentTagID','connectors.isPrivate','connectors.ownerIds',
          'ocpiData.evses.capabilities',
          'chargePoints.chargePointID','chargePoints.currentType','chargePoints.voltage','chargePoints.amperage','chargePoints.numberOfConnectedPhase',
          'chargePoints.cannotChargeInParallel','chargePoints.sharePowerToAllConnectors','chargePoints.excludeFromPowerLimitation','chargePoints.ocppParamForPowerLimitation',
          'chargePoints.power','chargePoints.efficiency','chargePoints.connectorIDs'
      ...
      },
      {
        ...
        attributes: [
          ...
          'chargePoints.cannotChargeInParallel','chargePoints.sharePowerToAllConnectors','chargePoints.excludeFromPowerLimitation','chargePoints.ocppParamForPowerLimitation',
          'chargePoints.power','chargePoints.efficiency','chargePoints.connectorIDs',
          'connectors.status', 'connectors.type', 'connectors.power', 'connectors.errorCode', 'connectors.connectorId', 'connectors.currentTotalConsumptionWh','connectors.isPrivate','connectors.ownerIds',
      ...
      {
        resource: Entity.CHARGING_STATION, action: [Action.RESERVE_NOW, Action.REMOTE_START_TRANSACTION, Action.REMOTE_STOP_TRANSACTION,Action.ASSIGN_UNASSIGN_USERS_TO_CONNECTOR],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
      ...
      {
        resource: Entity.CONNECTOR, action: [Action.REMOTE_START_TRANSACTION,Action.ASSIGN_UNASSIGN_USERS_TO_CONNECTOR],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
...

      {
        ...
        attributes: [
          'userID', 'issuer', 'active', 'description', 'visualID',
          'user.id', 'user.name', 'user.firstName', 'user.email', 'user.issuer'
        ],
      },
      {
      ...
      {
        resource: Entity.EMAID, action: [Action.UNASSIGN, Action.UPDATE_BY_VISUAL_ID],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: ['OwnUser'],
      ...
      {
        resource: Entity.EMAID, action: Action.ASSIGN,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
        ...
        attributes: [
          'userID', 'description', 'visualID','user.name',
          'user.firstName', 'user.email', 'createdOn', 'lastChangedOn'
        ]
      },
      ...
      },
      {
        ...
        attributes: [
          ...
          'carCatalog.vehicleMake', 'carCatalog.vehicleModel', 'carCatalog.vehicleModelVersion',
          'car.licensePlate',
          'billingData.stop.invoiceNumber', 'ocpi', 'ocpiWithCdr','tag.ocpiToken.issuer'
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.GET_REFUND_REPORT,
    ...
    grants: [
      ...
      },
      {
        ...
        attributes: [
          ...
          'siteAreaID', 'siteArea.id', 'siteArea.name', 'siteArea.siteID', 'site.name', 'siteArea.address', 'siteID', 'maximumPower', 'powerLimitUnit',
          'connectors.connectorId', 'connectors.status', 'connectors.type', 'connectors.power', 'connectors.errorCode',
          'connectors.currentTotalConsumptionWh', 'connectors.currentInstantWatts', 'connectors.currentStateOfCharge', 'connectors.info', 'connectors.vendorErrorCode','connectors.isPrivate','connectors.ownerIds',
          'connectors.currentTransactionID', 'connectors.currentTotalInactivitySecs', 'lastReboot', 'createdOn', 'companyID',
          'ocpiData.evses.capabilities',
          'chargePoints.chargePointID','chargePoints.currentType','chargePoints.voltage','chargePoints.amperage','chargePoints.numberOfConnectedPhase',
          'chargePoints.cannotChargeInParallel','chargePoints.sharePowerToAllConnectors','chargePoints.excludeFromPowerLimitation','chargePoints.ocppParamForPowerLimitation',
      ...
      },
      {
        ...
        attributes: [
          ...
          'site.name', 'siteArea.name', 'company.name',
          'billingData.stop.invoiceNumber', 'stop.reason', 'ocpi', 'ocpiWithCdr', 'tagID', 'tag.visualID', 'tag.description', 'stop.tagID', 'stop.tag.visualID','tag.ocpiToken.issuer'
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.GET_REFUND_REPORT,
  ...
  siteAdmin: {
    ...
    grants: [
      ...
      {
        resource: Entity.EMAID, action: [Action.ASSIGN, Action.UNASSIGN, Action.UPDATE_BY_VISUAL_ID],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: [],
      ...
      },
      {
        ...
        attributes: [
          ...
          'currentCumulatedPrice', 'currentInactivityStatus', 'roundedPrice', 'price', 'priceUnit', 'tagID', 'tag.visualID', 'tag.description', 'site.name', 'siteArea.name', 'company.name',
          'car.licensePlate',
          'userID', 'user.id', 'user.name', 'user.firstName', 'user.email','tariffIDs','tariffIDs'
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.GET_COMPLETED_TRANSACTION,
      ...
      {
        resource: Entity.EMAID, action: Action.UPDATE,
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
            asserts: ['UserMandatory'],
    ...
    grants: [
      ...
      },
      {
        ...
        attributes: [
          ...
          'userID', 'user.id', 'user.name', 'user.firstName', 'user.email',
          'carCatalog.vehicleMake', 'carCatalog.vehicleModel', 'carCatalog.vehicleModelVersion',
          'car.licensePlate','tariffData','pricingModel'
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.GET_COMPLETED_TRANSACTION,
  ...
  qrcode: {
    grants: [
      ...
      {
        resource: Entity.EMAID, action: Action.LIST,
        attributes: [
          'id', 'userID', 'active',  'description', 'visualID', 'issuer',
          'user.name', 'user.firstName', 'user.email', 'createdOn', 'lastChangedOn',
        ]
      },
      ...
      { resource: Entity.TAG, action: [Action.IMPORT, Action.EXPORT] },
      {
        ...
        attributes: [
          'id', 'userID', 'issuer', 'active', 'description', 'visualID', 'user.id','fromEMSP',
          'user.name', 'user.firstName', 'user.email'
        ]
      },
      { resource: Entity.TAG, action: Action.CREATE },
      ...
      { resource: Entity.CHARGING_PROFILE, action: [Action.READ, Action.CREATE, Action.UPDATE] },
      {
        resource: Entity.COMPANY, action: Action.READ,
        attributes: [
          'id', 'name', 'issuer', 'logo',
      ...
      },
      {
        resource: Entity.SITE,
        action: [
          Action.CREATE, Action.UPDATE, Action.EXPORT_OCPP_PARAMS, Action.GENERATE_QR, Action.MAINTAIN_PRICING_DEFINITIONS,
        ],
        condition: {
          Fn: 'custom:dynamicAuthorizations',
          args: {
      ...
      },
      {
        resource: Entity.SITE_AREA,
        action: [
          Action.CREATE, Action.UPDATE, Action.ASSIGN_ASSETS_TO_SITE_AREA,
          Action.UNASSIGN_ASSETS_FROM_SITE_AREA, Action.ASSIGN_CHARGING_STATIONS_TO_SITE_AREA,
          Action.UNASSIGN_CHARGING_STATIONS_FROM_SITE_AREA, Action.EXPORT_OCPP_PARAMS, Action.GENERATE_QR,
          Action.READ_ASSETS_FROM_SITE_AREA
        ],
      ...
      },
      {
        resource: Entity.CHARGING_STATION,
        action: [
          Action.RESET, Action.CLEAR_CACHE, Action.CHANGE_AVAILABILITY, Action.UPDATE, Action.GENERATE_QR,
          Action.GET_CONFIGURATION, Action.CHANGE_CONFIGURATION, Action.STOP_TRANSACTION, Action.START_TRANSACTION,
          Action.AUTHORIZE, Action.SET_CHARGING_PROFILE,Action.GET_COMPOSITE_SCHEDULE, Action.CLEAR_CHARGING_PROFILE, Action.GET_DIAGNOSTICS, Action.UPDATE_FIRMWARE,
          Action.EXPORT_OCPP_PARAMS, Action.TRIGGER_DATA_TRANSFER, Action.UPDATE_OCPP_PARAMS, Action.LIMIT_POWER, Action.DELETE_CHARGING_PROFILE, Action.GET_OCPP_PARAMS,
          Action.UPDATE_CHARGING_PROFILE, Action.GET_CONNECTOR_QR_CODE, Action.MAINTAIN_PRICING_DEFINITIONS ,Action.ASSIGN_UNASSIGN_USER_TO_CHARGING_STATION_CONNECTOR
      ...
      },
      {
        ...
        attributes: [
          ...
          'stop.roundedPrice', 'stop.stateOfCharge', 'stop.tag.visualID', 'stop.tagID', 'stop.timestamp', 'stop.totalConsumptionWh',
          'stop.totalDurationSecs', 'stop.totalInactivitySecs', 'stop.userID', 'tag.description', 'tag.visualID', 'tagID', 'timestamp', 'timezone',
          'userID', 'user.id', 'user.email', 'user.firstName', 'user.name','tag.ocpiToken.issuer'
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.GET_REFUND_REPORT,
      ...
      {
        resource: Entity.TRANSACTION, action: [
          Action.EXPORT, Action.SYNCHRONIZE_REFUNDED_TRANSACTION, Action.UPDATE, Action.REMOTE_STOP_TRANSACTION
        ]
      },
      {
        resource: Entity.TRANSACTION, action: Action.PUSH_TRANSACTION_CDR,
