...
import { GetInstalledCertificateIdsRequest, GetInstalledCertificateIdsResponse } from '../../../types/ocpp/OCPPServer';
...
export default class JsonChargingStationClient extends ChargingStationClient {
  ...
  public async getInstalledCertificateIds(params: GetInstalledCertificateIdsRequest): Promise<GetInstalledCertificateIdsResponse> {
    return this.sendMessage(Command.GET_INSTALLED_CERTIFICATE_IDS, params);
  }
