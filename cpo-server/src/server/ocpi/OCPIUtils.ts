...
import { OCPIConnector, OCPIConnectorMultipleTarif, OCPIConnectorType, OCPIPowerType } from '../../types/ocpi/OCPIConnector';
...
export default class OCPIUtils {
  ...
  public static convertEvseToChargingStationConnector(evse: OCPIEvse, evseConnector: OCPIConnector | OCPIConnectorMultipleTarif, connectorID: number): Connector {
    return {
      id: evseConnector.id,
      ...
      tariffIDs: evseConnector['tariff_ids'],
