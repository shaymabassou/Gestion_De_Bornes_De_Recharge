...
import EmaidService from './v1/service/EmaidService';
import CertificatService from './v1/service/CertificatService';
    ...
    switch (httpVerb) {
      ...
      case 'POST':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.OCPI_ENDPOINT_SEND_EVSES]: OCPIEndpointService.handlePatchLocationsOcpiEndpoint.bind(this),
          ...
          [ServerAction.EMAID_CREATE]: EmaidService.handleCreateEmaid.bind(this),
          [ServerAction.TAGS_IMPORT]: TagService.handleImportTags.bind(this),
          [ServerAction.EMAIDS_IMPORT]: EmaidService.handleImportEmaids.bind(this),
        });
        break;
      ...
      case 'GET':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.CERTIFICATES]: CertificatService.handleGetCertificates.bind(this),
          [ServerAction.CERTIFICATE]: CertificatService.handleGetCertificate.bind(this),
          [ServerAction.EMAIDS]: EmaidService.handleGetEmaids.bind(this),
          [ServerAction.EMAID]: EmaidService.handleGetEmaid.bind(this),
          [ServerAction.EMAID_BY_VISUAL_ID]: EmaidService.handleGetEmaidByVisualID.bind(this),
          [ServerAction.EMAIDS_EXPORT]: EmaidService.handleExportEmaids.bind(this),
      ...
      case 'PUT':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.EMAID_UPDATE]: EmaidService.handleUpdateEmaid.bind(this),
          [ServerAction.EMAID_UPDATE_BY_VISUAL_ID]: EmaidService.handleUpdateEmaidByVisualID.bind(this),
          [ServerAction.EMAIDS_UNASSIGN]: EmaidService.handleUnassignEmaids.bind(this),
          [ServerAction.EMAID_UNASSIGN]: EmaidService.handleUnassignEmaid.bind(this),
          [ServerAction.EMAID_ASSIGN]: EmaidService.handleAssignEmaid.bind(this),
          [ServerAction.REGISTRATION_TOKEN_UPDATE]: RegistrationTokenService.handleUpdateRegistrationToken.bind(this),
          // [ServerAction.CERTIFICATES_UNASSIGN]: CertificateService.handleUnassignCertificates.bind(this),
          // [ServerAction.CERTIFICATE_UNASSIGN]: CertificateService.handleUnassignCertificate.bind(this),
          // [ServerAction.CERTIFICATE_ASSIGN]: CertificateService.handleAssignCertificate.bind(this),
        });
        break;
      ...
      case 'DELETE':
        ...
        this.registerJsonActionsPaths({
          ...
          [ServerAction.CERTIFICATE_DELETE]: CertificatService.handleDeleteCertificate.bind(this),
          [ServerAction.CERTIFICATES_DELETE]: CertificatService.handleDeleteCertificates.bind(this),
          [ServerAction.EMAID_DELETE]: EmaidService.handleDeleteEmaid.bind(this),
          [ServerAction.EMAIDS_DELETE]: EmaidService.handleDeleteEmaids.bind(this),
        ...
        case 'GET':
          ...
          switch (action) {
            ...
            case ServerAction.COMPANY_LOGO:
              ...
              break;
            case ServerAction.COMPANY_FAVICON:
              await CompanyService.handleGetCompanyFavicon(action, req, res, next);
              break;
            case ServerAction.COMPANY_COLORS:
              await CompanyService.handleGetCompanyColors(action, req, res, next);
              break;
            ...
            case ServerAction.TENANT_LOGO:
              ...
              break;
            case ServerAction.TENANT_FAVICON:
              await TenantService.handleGetTenantFavicon(action, req, res, next);
              break;
            case ServerAction.TENANT_COLORS:
              await TenantService.handleGetTenantColors(action, req, res, next);
              break;
            case ServerAction.TENANT_LIST:
              await TenantService.handleGetTenantsList(action, req, res, next);
              break;
            default:
              // Delegate
