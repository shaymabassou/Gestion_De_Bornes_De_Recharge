...
export default class UserValidatorRest extends SchemaValidator {
  ...
  private userCreateQrCode: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/user/user-qrcode-create.json`, 'utf8'));
  ...
  public validateQRcodeUserCreateReq(data: Record<string, unknown>): HttpUserCreateRequest {
    return this.validate(this.userCreate, data);
  }
