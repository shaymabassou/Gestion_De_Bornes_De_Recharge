...
export default class ChargingStationValidatorRest extends SchemaValidator {
  ...
  private chargingStationTariffGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/chargingstation/chargingstation-tariff-get.json`, 'utf8'));
  ...
  private smartChargingByTarifTrigger: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/chargingstation/smartchargingbytarif-trigger.json`, 'utf8'));
  ...
  private chargingStationQrCodeGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/chargingstation/chargingstation-qrcode-get.json`, 'utf8'));
  ...
  public validateChargingStationQRCodeGetReq(data: Record<string, unknown>): HttpChargingStationGetRequest {
    return this.validate(this.chargingStationQrCodeGet, data);
  }
  ...
  public validateChargingStationTariffGetReq(data: Record<string, unknown>): HttpChargingStationTariffGetRequest {
    return this.validate(this.chargingStationTariffGet, data);
  }
  ...
  public validateSmartChargingByTarifTriggerReq(data: Record<string, unknown>): HttpSmartChargingByTarifTriggerRequest {
    return this.validate(this.smartChargingByTarifTrigger, data);
  }
