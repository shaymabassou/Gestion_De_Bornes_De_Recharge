import { HttpEditPricingGetRequest, HttpPricingDefinitionCreateRequest, HttpPricingDefinitionUpdateRequest, HttpPricingDefinitionsDeleteRequest, HttpPricingDefinitionsGetRequest, HttpPricingDefinitionsGetRequestQrCode, HttpPricingModelResolutionGetRequest } from '../../../../types/requests/HttpPricingRequest';
...
export default class PricingValidatorRest extends SchemaValidator {
  ...
  private qrCodePricingDefinitionsGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/pricing/pricing-definitions-qrcode-get.json`, 'utf8'));
  ...
  private editRemotePricing: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/pricing/edit-remote-pricing.json`, 'utf8'));
  ...
  public validatePricingDefinitionsGetQrCode(data: Record<string, unknown>): HttpPricingDefinitionsGetRequestQrCode {
    return this.validate(this.qrCodePricingDefinitionsGet, data);
  }
  ...
  public validateEditRemotePricing(data: Record<string, unknown>): HttpEditPricingGetRequest {
    return this.validate(this.editRemotePricing, data);
  }
}
