import { HttpCompaniesGetRequest, HttpCompanyDeleteRequest, HttpCompanyFaviconGetRequest, HttpCompanyGetRequest, HttpCompanyLogoGetRequest } from '../../../../types/requests/HttpCompanyRequest';
...
export default class CompanyValidatorRest extends SchemaValidator {
  ...
  private companyFaviconGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/company/company-favicon-get.json`, 'utf8'));
  ...
  public validateCompanyFaviconGetReq(data: Record<string, unknown>): HttpCompanyFaviconGetRequest {
    return this.validate(this.companyFaviconGet, data);
  }
}
