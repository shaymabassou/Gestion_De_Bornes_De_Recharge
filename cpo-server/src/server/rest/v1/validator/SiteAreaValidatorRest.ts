import { HttpAssignAssetsToSiteAreaRequest,HttpAssignChargingStationToSiteAreaRequest,HttpSiteAreaConsumptionsRequest,HttpSiteAreaCreateRequest,HttpSiteAreaCreateUpdateRequest, HttpSiteAreaDeleteRequest, HttpSiteAreaGetRequest, HttpSiteAreaImageGetRequest, HttpSiteAreaUpdateRequest, HttpSiteAreasGetRequest } from '../../../../types/requests/HttpSiteAreaRequest';
...
export default class SiteAreaValidatorRest extends SchemaValidator {
  ...
  public validateSiteAreaUpdateReq(data: Record<string, unknown>): HttpSiteAreaCreateUpdateRequest {
  ...
  public validateSiteAreaGetConsumptionReq(data: Record<string, unknown>): HttpSiteAreaCreateUpdateRequest {
