import { HttpOCPIEndpointByIdWithOffsetRequest, HttpOCPIEndpointCommandRequest, HttpOCPIEndpointCreateRequest, HttpOCPIEndpointDeafultSetRequest, HttpOCPIEndpointDeleteRequest, HttpOCPIEndpointGetRequest, HttpOCPIEndpointPingRequest, HttpOCPIEndpointUpdateRequest, HttpOCPIEndpointsGetRequest } from '../../../../types/requests/HttpOCPIEndpointRequest';
...
export default class OCPIEndpointValidatorRest extends SchemaValidator {
  ...
  private ocpiEndpointDefaultSet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/ocpi/ocpi-endpoint-default-set.json`, 'utf8'));
  private ocpiEndpointByIdWithOffset: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/ocpi/ocpi-endpoint-by-id-with-offset.json`, 'utf8'));
  ...
  public validateOCPIEndpointByIdReq(data: Record<string, unknown>): HttpOCPIEndpointGetRequest {
  ...
  public validateOCPIEndpointByIdWithOffsetReq(data: Record<string, unknown>): HttpOCPIEndpointByIdWithOffsetRequest {
    return this.validate(this.ocpiEndpointByIdWithOffset, data);
  }
  ...
  public validateOCPIEndpointDefaultSetReq(data: Record<string, unknown>): HttpOCPIEndpointDeafultSetRequest {
    return this.validate(this.ocpiEndpointDefaultSet, data);
  }
}
