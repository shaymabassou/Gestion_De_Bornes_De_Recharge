import { HttpEmspRequest, HttpTagAssignRequest, HttpTagByVisualIDGetRequest, HttpTagByVisualIDUnassignRequest, HttpTagCreateRequest, HttpTagDeleteRequest, HttpTagGetRequest, HttpTagUpdateRequest, HttpTagsByVisualIDsUnassignRequest, HttpTagsDeleteRequest, HttpTagsGetRequest } from '../../../../types/requests/HttpTagRequest';
...
export default class TagValidatorRest extends SchemaValidator {
  ...
  private emspsGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/tag/tag-get-emsp.json`, 'utf8'));
