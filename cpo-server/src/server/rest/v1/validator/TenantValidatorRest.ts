import { HttpTenantColorsGetRequest, HttpTenantDeleteRequest, HttpTenantFaviconGetRequest, HttpTenantGetRequest, HttpTenantLogoGetRequest, HttpTenantsGetRequest } from '../../../../types/requests/HttpTenantRequest';
...
export default class TenantValidatorRest extends SchemaValidator {
  ...
  private tenantFaviconGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/tenant/tenant-favicon-get.json`, 'utf8'));
  private tenantColorsGet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/tenant/tenant-colors-get.json`, 'utf8'));
  ...
  public validateFaviconGetReq(data: Record<string, unknown>): HttpTenantFaviconGetRequest {
    return this.validate(this.tenantFaviconGet, data);
  }

  public validateColorsGetReq(data: Record<string, unknown>): HttpTenantColorsGetRequest {
    return this.validate(this.tenantColorsGet, data);
  }
