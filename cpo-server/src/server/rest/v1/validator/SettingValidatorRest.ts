...
export default class SettingValidatorRest extends SchemaValidator {
  ...
  private settingDoubleAccessSet: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/server/rest/v1/schemas/setting/setting-double-access-set.json`, 'utf8'));
  ...
  public validateSettingAssetSetReq(data: Record<string, unknown>): HttpSettingUpdateRequest {
    console.log('------------------------------------data setting: ',JSON.stringify(data));
  ...
  public validateSettingDoubleAccessSetReq(data: Record<string, unknown>): HttpSettingUpdateRequest {
    return this.validate(this.settingDoubleAccessSet, data);
  }
}
