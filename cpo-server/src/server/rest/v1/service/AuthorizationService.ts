...
import { HttpEmaidGetRequest, HttpEmaidsGetRequest } from '../../../../types/requests/HttpEmaidRequest';
import Emaid from '../../../../types/Emaid';
import { Certificate } from '../../../../types/Certificate';
import { HttpCertificateDeleteRequest, HttpCertificateGetRequest, HttpCertificatesGetRequest } from '../../../../types/requests/HttpCertificateRequest';
...
export default class AuthorizationService {
  ...
  public static async checkAndGetEmaidsAuthorizations(tenant: Tenant, userToken: UserToken,
    filteredRequest: Partial<HttpEmaidsGetRequest>, failsWithException = true): Promise<AuthorizationFilter> {
  const authorizations: AuthorizationFilter = {
    filters: {},
    dataSources: new Map(),
    projectFields: [],
  ...
  // Check static & dynamic authorization
  await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.EMAID, Action.LIST, authorizations, filteredRequest, null, failsWithException);
  return authorizations;
}
//POUR LES CERTIFICATS 
public static async checkAndGetCertificatesAuthorizations(tenant: Tenant, userToken: UserToken,
  filteredRequest: Partial<HttpCertificatesGetRequest>, failsWithException = true): Promise<AuthorizationFilter> {
const authorizations: AuthorizationFilter = {
  filters: {},
  dataSources: new Map(),
  projectFields: [],
...
// Check static & dynamic authorization
await AuthorizationService.canPerformAuthorizationAction(
  tenant, userToken, Entity.CERTIFICATE, Action.LIST, authorizations, filteredRequest, null, failsWithException);
return authorizations;
}


  public static async checkAndGetEmspsAuthorizations(tenant: Tenant, userToken: UserToken,
      filteredRequest: Partial<HttpTagsGetRequest>, failsWithException = true): Promise<AuthorizationFilter> {
    const authorizations: AuthorizationFilter = {
      filters: {},
      dataSources: new Map(),
    ...
    // Check static & dynamic authorization
    await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.TAG, Action.LIST_BAGDES_EMSPS, authorizations, filteredRequest, null, failsWithException);
    return authorizations;
  }
  ...
  public static async checkAndGetEmaidAuthorizations(tenant: Tenant, userToken: UserToken,
    filteredRequest: Partial<HttpEmaidGetRequest>, authAction: Action, entityData?: EntityData): Promise<AuthorizationFilter> {
  return AuthorizationService.checkAndGetEntityAuthorizations(
    tenant, Entity.EMAID, userToken, filteredRequest, filteredRequest.ID ? { EmaidID: filteredRequest.ID } : {}, authAction, entityData);
}

public static async checkAndGetCertificateAuthorizations(tenant: Tenant, userToken: UserToken,
  filteredRequest: Partial<HttpCertificateGetRequest>, authAction: Action, entityData?: EntityData): Promise<AuthorizationFilter> {
return AuthorizationService.checkAndGetEntityAuthorizations(
  tenant, Entity.CERTIFICATE, userToken, filteredRequest, filteredRequest.ID ? { CertificateID: filteredRequest.ID } : {}, authAction, entityData);
}

public static async addCertificatesAuthorizations(tenant: Tenant, userToken: UserToken, certificates: CertificateDataResult, authorizationFilter: AuthorizationFilter): Promise<void> {
  // Add Meta Data
  certificates.metadata = authorizationFilter.metadata;
  // Add Authorizations
  certificates.canAssign = await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.CERTIFICATE, Action.ASSIGN, authorizationFilter);
    certificates.canDelete = await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.CERTIFICATE, Action.DELETE, authorizationFilter);
    certificates.canUnassign = await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.CERTIFICATE, Action.UNASSIGN, authorizationFilter);
    certificates.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.USER, Action.LIST, authorizationFilter);
    certificates.canListSources = await AuthorizationService.canPerformAuthorizationAction(
    tenant, userToken, Entity.SOURCE, Action.LIST, authorizationFilter);
  for (const certificate of certificates.result) {
    await AuthorizationService.addCertificateAuthorizations(tenant, userToken, certificate, authorizationFilter);
  }
}
  ...
  public static async addEmaidsAuthorizations(tenant: Tenant, userToken: UserToken, emaids: EmaidDataResult, authorizationFilter: AuthorizationFilter): Promise<void> {
    // Add Meta Data
    emaids.metadata = authorizationFilter.metadata;
    // Add Authorizations
      emaids.canCreate = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.CREATE, authorizationFilter);
      emaids.canAssign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.ASSIGN, authorizationFilter);
      emaids.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.DELETE, authorizationFilter);
      emaids.canImport = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.IMPORT, authorizationFilter);
      emaids.canExport = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.EXPORT, authorizationFilter);
      emaids.canUnassign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.UNASSIGN, authorizationFilter);
      emaids.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.USER, Action.LIST, authorizationFilter);
      emaids.canListSources = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.SOURCE, Action.LIST, authorizationFilter);
    for (const emaid of emaids.result) {
      await AuthorizationService.addEmaidAuthorizations(tenant, userToken, emaid, authorizationFilter);
    }
  }
  ...
  public static async addEmaidAuthorizations(tenant: Tenant, userToken: UserToken, emaid:Emaid, authorizationFilter: AuthorizationFilter): Promise<void> {
    emaid.canRead = true; // Always true as it should be filtered upfront
    emaid.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.DELETE, authorizationFilter, { EmaidID: emaid.id }, emaid);
    emaid.canUpdate = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.UPDATE, authorizationFilter, { EmaidID: emaid.id }, emaid);
    emaid.canUpdateByVisualID = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.UPDATE_BY_VISUAL_ID, authorizationFilter, { EmaidID: emaid.id }, emaid);
    emaid.canUnassign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.UNASSIGN, authorizationFilter, { EmaidID: emaid.id }, emaid);
    emaid.canAssign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.EMAID, Action.ASSIGN, authorizationFilter, { EmaidID: emaid.id }, emaid);
    emaid.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.USER, Action.LIST, authorizationFilter);
    // Optimize data over the net
    Utils.removeCanPropertiesWithFalseValue(emaid);
  }



  
public static async addCertificateAuthorizations(tenant: Tenant, userToken: UserToken, certificate: Certificate, authorizationFilter: AuthorizationFilter): Promise<void> {
  certificate.canRead = true;
  certificate.canDelete = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.CERTIFICATE, Action.DELETE, authorizationFilter, { CertificateID: certificate.id }, certificate);
  certificate.canUnassign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.CERTIFICATE, Action.UNASSIGN, authorizationFilter, { CertificateID: certificate.id }, certificate);
  certificate.canAssign = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.CERTIFICATE, Action.ASSIGN, authorizationFilter, { CertificateID: certificate.id }, certificate);
  certificate.canListUsers = await AuthorizationService.canPerformAuthorizationAction(
      tenant, userToken, Entity.USER, Action.LIST, authorizationFilter);
  certificate.canRevoke = await AuthorizationService.canPerformAuthorizationAction(
        tenant, userToken, Entity.CERTIFICATE, Action.REVOKE, authorizationFilter, { CertificateID: certificate.id }, certificate);
  // Optimiser les données sur le réseau
  Utils.removeCanPropertiesWithFalseValue(certificate);
}
  ...
  public static async addChargingStationAuthorizations(tenant: Tenant, userToken: UserToken, chargingStation: ChargingStation,
    ...
    for (const connector of chargingStation.connectors || []) {
      ...
      // can assign users to connetor if bore vip is active
      if (Utils.isTenantComponentActive(tenant,TenantComponents.BORNE_VIP)) {
        connector.canAssignUnassignUsersToConnector = await AuthorizationService.canPerformAuthorizationAction(tenant, userToken, Entity.CONNECTOR, Action.ASSIGN_UNASSIGN_USERS_TO_CONNECTOR, authorizationFilter,
          { chargingStationID: chargingStation.id, UserID: connector.user?.id, SiteID: chargingStation.siteID }, connector);
      }
  ...
  public static async addTransactionsAuthorizations(tenant: Tenant, userToken: UserToken,
    ...
    //transactions.canListEmaids = await AuthorizationService.canPerformAuthorizationAction(tenant, userToken, Entity.EMAID, Action.LIST, authorizationFilter);
    ...
    transactions.canListEmsp = await AuthorizationService.canPerformAuthorizationAction(tenant, userToken, Entity.TAG, Action.LIST_BAGDES_EMSPS, authorizationFilter);
    // Add Authorizations
  ...
  private static filterProjectFields(authFields: string[], httpProjectField: string): string[] {
    ...
    if (!Utils.isEmptyArray(applicableProjectedFields) && !Utils.isEmptyArray(httpProjectFields)) {
      httpProjectFields = httpProjectFields.filter(
        (myhttpProjectField) => applicableProjectedFields.includes(myhttpProjectField));
    }
