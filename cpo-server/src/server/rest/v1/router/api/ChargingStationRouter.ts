...
export default class ChargingStationRouter {
  ...
  public buildRoutes(): express.Router {
    ...
    this.buildRouteChargingStationTriggerSmartChargingByTarif();
    ...
    this.buildRouteChargingStationConnector();
    this.buildRouteChargingStationTariffID();
    this.buildRouteChargingStationConnectorOwner();
    return this.router;
  }
  ...
  private buildRouteChargingStationConnector(): void {
    this.router.get(`/${RESTServerRoute.REST_CHARGING_STATION_CONNECTOR}`, (req: Request, res: Response, next: NextFunction) => {
      req.query.ChargingStationID = req.params.id;
      req.query.ConnectorID = req.params.connectorId;
      void RouterUtils.handleRestServerAction(ChargingStationService.handleGetChargingStationConnector.bind(this), ServerAction.CHARGING_STATION_CONNECTOR, req, res, next);
    });
  }

  private buildRouteChargingStationConnectorOwner(): void {
    this.router.put(`/${RESTServerRoute.REST_CHARGING_STATION_CONNECTOR_USER}`, (req: Request, res: Response, next: NextFunction) => {
      req.query.ChargingStationID = req.params.id;
      req.query.ConnectorID = req.params.connectorId;
      void RouterUtils.handleRestServerAction(ChargingStationService.handleChargingStationConnectorOwner.bind(this), ServerAction.CHARGING_STATION_CONNECTOR, req, res, next);
    });
  }
  ...
  private buildRouteChargingStationTariffID(): void {
    this.router.get(`/${RESTServerRoute.REST_CHARGING_STATION_TARIFF_ID}`, (req: Request, res: Response, next: NextFunction) => {
      ...
      void RouterUtils.handleRestServerAction(ChargingStationService.handleGetChargingStationTariff.bind(this), ServerAction.CHARGING_STATION, req, res, next);
    });
  }
  ...
  private buildRouteChargingStationTriggerSmartChargingByTarif(): void {
    this.router.get(`/${RESTServerRoute.REST_CHARGING_STATION_TRIGGER_SMART_CHARGING_BY_TARIF}`, (req: Request, res: Response, next: NextFunction) => {
      void RouterUtils.handleRestServerAction(ChargingStationService.handleTriggerSmartChargingByTarif.bind(this), ServerAction.TRIGGER_SMART_CHARGING, req, res, next);
    });
  }
