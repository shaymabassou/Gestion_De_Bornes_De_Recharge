...
export default class PricingRouter {
  ...
  public buildEditRoute(): express.Router {
    this.buildRoutehandleEditRemotePricing();
    return this.router;
  }
  ...
  protected buildRoutehandleEditRemotePricing(): void {
    this.router.get(`/${RESTServerRoute.EDIT_REMOTE_PRICING}`, (req: Request, res: Response, next: NextFunction) => {
      void RouterUtils.handleRestServerAction(PricingService.handleEditRemotePricing.bind(this), ServerAction.EDIT_REMOTE_PRICING, req, res, next);
    });
  }
