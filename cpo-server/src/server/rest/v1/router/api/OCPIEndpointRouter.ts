...
export default class OCPIEndpointRouter {
  ...
  public buildRoutes(): express.Router {
    ...
    this.buildRouteOcpiEndpointSetDefault();
    ...
    this.buildRouteOcpiEndpointPullInterruptedTokens();
    this.buildRouteOcpiEndpointPullTokensWithOffset();
    this.buildRouteOcpiEndpointPatchLocations();
    return this.router;
  }
  ...
  private buildRouteOcpiEndpointPullTokensWithOffset(): void {
    this.router.put(`/${RESTServerRoute.REST_OCPI_ENDPOINT_PULL_TOKENS_WITH_OFFSET}`, (req: Request, res: Response, next: NextFunction) => {
      req.body.id = req.params.id;
      req.body.offset = req.params.offset;
      void RouterUtils.handleRestServerAction(OCPIEndpointService.handlePullTokensWithOffsetEndpoint.bind(this), ServerAction.OCPI_CPO_GET_TOKENS, req, res, next);
    });
  }

  private buildRouteOcpiEndpointPullInterruptedTokens(): void {
    this.router.put(`/${RESTServerRoute.REST_OCPI_ENDPOINT_PULL_INTERRUPTED_TOKENS}`, (req: Request, res: Response, next: NextFunction) => {
      req.body.id = req.params.id;
      void RouterUtils.handleRestServerAction(OCPIEndpointService.handlePullInterruptedTokens.bind(this), ServerAction.OCPI_CPO_GET_TOKENS, req, res, next);
    });
  }

  private buildRouteOcpiEndpointPatchLocations(): void {
    this.router.put(`/${RESTServerRoute.REST_OCPI_ENDPOINT_PATCH_LOCATIONS}`, (req: Request, res: Response, next: NextFunction) => {
      req.body.id = req.params.id;
      void RouterUtils.handleRestServerAction(OCPIEndpointService.handlePatchLocationsOcpiEndpoint.bind(this), ServerAction.OCPI_ENDPOINT_SEND_EVSE_STATUSES, req, res, next);
    });
  }
  ...
  private buildRouteOcpiEndpointSetDefault(): void {
    this.router.put(`/${RESTServerRoute.REST_OCPI_ENDPOINT_DEFAULT}`, (req: Request, res: Response, next: NextFunction) => {
      req.body.id = req.params.id;
      void RouterUtils.handleRestServerAction(OCPIEndpointService.handleSetDefaultOcpiEndpoint.bind(this), ServerAction.OCPI_ENDPOINT_UPDATE, req, res, next);
    });
  }
