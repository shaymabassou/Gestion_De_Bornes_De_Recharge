...
export default class StatisticsRouter {
  ...
  public buildRoutes(): express.Router {
    ...
    this.buildRouteDashboardStatistics();
  ...
  private buildRouteDashboardStatistics(): void {
    this.router.get(`/${RESTServerRoute.REST_DASHBOARD_STATISTICS}`, (req: Request, res: Response, next: NextFunction) => {
      void RouterUtils.handleRestServerAction(StatisticService.handleGetDashboardStatistics.bind(this), ServerAction.DASHBOARD_STATISTICS, req, res, next);
    });
  }
