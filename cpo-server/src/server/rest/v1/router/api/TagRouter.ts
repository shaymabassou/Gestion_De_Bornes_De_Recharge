...
export default class TagRouter {
  ...
  private buildRouteGetTagsEmsps(): void {
    this.router.get(`/${RESTServerRoute.REST_TAGS_EMSP}`, (req: Request, res: Response, next: NextFunction) => {
      void RouterUtils.handleRestServerAction(TagService.handleGetTagsEmsps.bind(this), ServerAction.TAGS_EMSP, req, res, next);
    });
  }
