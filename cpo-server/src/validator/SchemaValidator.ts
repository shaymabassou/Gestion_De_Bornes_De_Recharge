...
export default class SchemaValidator {
  ...
  private static certificateSchema: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/schemas/certificate/certificate.json`, 'utf8'));
  private static emaidSchema: Schema = JSON.parse(fs.readFileSync(`${global.appRoot}/assets/schemas/emaid/emaid.json`, 'utf8'));
  ...
  protected constructor(moduleName: string,
    ...
    this.ajv.addSchema([
      ...
      SchemaValidator.emaidSchema,
      SchemaValidator.certificateSchema,
