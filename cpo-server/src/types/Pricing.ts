...
import { OCPITariff } from './ocpi/OCPITariff';
...
export interface PricingOcpiData {
  tariff?: OCPITariff;
  tariffCheckedOn?: Date;
  tariffUpdatedOn?: Date;
  inEmsp?: boolean;
}
