...
export interface SettingDBContent {
  ...
  | TaskSettingsType
  | DoubleAccessSettingsType
  | MultipleTarifsSettingsType;
  ocpi?: OcpiSetting;
  oicp?: OicpSetting;
  ...
  user?: UserSetting;
  task?: TaskSetting;
  doubleAccess?: DoubleAccessSetting;
  multipleTarifs?: MultipleTarifsSettings;
}
...
export interface AssetConnectionSetting {
  ...
  schneiderTestConnection?: AssetSchniederTestConnetionType;
}

export enum AssetConnectionType {
  SCHNEIDER_TEST ='schneider_test',
  SCHNEIDER = 'schneider',
  GREENCOM = 'greencom',
  IOTHINK = 'iothink',
  WIT = 'wit',
...
export interface AssetTokenConnectionType {
  token: string;
  site_id: string;
}
...
export type AssetSchniederTestConnetionType = AssetTokenConnectionType;
...
export enum DoubleAccessSettingsType {
  DOUBLE_ACCESS = 'doubleAccess',
}
export interface DoubleAccessSettings extends Setting {
  identifier: TenantComponents.DOUBLE_ACCESS;
  type: DoubleAccessSettingsType;
  doubleAccess: DoubleAccessSetting
}

export interface DoubleAccessSetting {
  emsp: OcpiIdentifier;
  isActive: boolean;
  businessDetails?: OCPIBusinessDetails;
}

export enum MultipleTarifsSettingsType {
  MULTIPLE_TARIFS = 'multipleTarifs'
}
export interface MultipleTarifsSettings extends Setting {
  identifier: TenantComponents.MULTIPLE_TARIFS;
  type: MultipleTarifsSettingsType;
  isActive: boolean;
}
