...
export interface HttpPricingDefinitionsGetRequestQrCode extends HttpDatabaseRequest {
  ID?: string;
  Search?: string;
  EntityID?: string;
  EntityType?: PricingEntity;
...
export interface HttpEditPricingGetRequest extends HttpDatabaseRequest {
  subdomain?: string;
}

export interface HttpEditPricingRequest extends HttpDatabaseRequest {
  subdomain?: string;
}
