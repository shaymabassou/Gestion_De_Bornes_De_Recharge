...
export interface AuthorizationDefinition {
  ...
  qrcode: AuthorizationDefinitionRole;
}
...
export enum Action {
  ...
  ASSIGN_UNASSIGN_USERS_TO_CONNECTOR = 'AssignUnassignUsersToConnector',
  ...
  ASSIGN_UNASSIGN_USER_TO_CHARGING_STATION_CONNECTOR = 'AssignUnassignUserToChargingStationConnector'
}
...
export interface EmaidAuthorizationActions extends AuthorizationActions {
  canUnassign?: boolean;
  canAssign?: boolean;
  canUpdateByVisualID?: boolean;
}
...
export interface CertificateAuthorizationActions extends AuthorizationActions {
  canRevoke?: boolean;
}
...
export interface ChargingStationAuthorizationActions extends AuthorizationActions {
  ...
  canAssignUnassignUsersToConnector?:boolean;
