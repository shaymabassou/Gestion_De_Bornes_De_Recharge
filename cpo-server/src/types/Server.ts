...
export enum ServerAction {
  ...
  CHARGING_STATION_CONNECTOR = 'ChargingStationConnector',
  ...
  OCPI_ENDPOINT_SEND_EVSES = 'OcpiEndpointSendEVSES',
  ...
  OCPI_CPO_UPDATE_TARIFF = 'OcpiCpoUpdateTariff',
  OCPI_CPO_DELETE_TARIFF = 'OcpiCpoDeleteTariff',
  ...
  TENANT_FAVICON = 'TenantFavicon',
  TENANT_COLORS = 'TenantColors',
  TENANT_LIST = 'TenantsList',
  ...
  CERTIFICATES_UNASSIGN = 'CertificatesUnassign',
  CERTIFICATE_UNASSIGN = 'CertificateUnassign',
  CERTIFICATE_ASSIGN = 'CertificateAssign',
  ...
  SYNCHRONIZE_UNPAID_BILLS = 'SynchronizeUnpaidBills',
  ...
  EDIT_REMOTE_PRICING = 'EditRemotePricing',
  ...
  ASSIGN_USER_TO_CHARGING_STATION_CONNECTOR = 'assignUserFromChargingStationConnector',
  UNASSIGN_USER_FROM_CHARGING_STATION_CONNECTOR = 'ubassignUserFromChargingStationConnector',
  EMAID_UNASSIGN = "EMAID_UNASSIGN",
  EMAID_DELETE = 'EmaidDelete',
  EMAIDS_IMPORT = "EMAIDS_IMPORT",
  EMAIDS_DELETE = "EmaidsDelete",
  EMAID_UPDATE = 'EmaidUpdate',
  EMAID_CREATE = "EMAID_CREATE",
  EMAID_ASSIGN = 'EmaidAssign',
  EMAID_BY_VISUAL_ID = "EmaidUpdateByVisualID",
  EMAID_PROCESS_PDF = 'EmaidProcessPDF',
  EMAIDS = 'Emaids',
  EMAID ='Emaid',
  EMAIDS_UNASSIGN = "EMAIDS_UNASSIGN",
  EMAIDS_EXPORT = "EMAIDS_EXPORT",
  EMAID_UPDATE_BY_VISUAL_ID = "EmaidUpdateByVisualID",
  ...
  CERTIFICATE_RETRIEVE = "CERTIFICATE_RETRIEVE",
  CERTIFICATE_VALIDATION = "CERTIFICATE_VALIDATION",
  CERTIFICATE_OCSP_CHECK = "CERTIFICATE_OCSP_CHECK",
  CHARGING_STATION_GET_INSTALLED_CERTIFICATE_IDS = "CHARGING_STATION_GET_INSTALLED_CERTIFICATE_IDS",
...
export enum RESTServerRoute {
  ...
  REST_CHARGING_STATION_TARIFF_ID= 'charging-stations/tariffs/tariff',
  REST_CHARGING_STATION_QR = 'charging-stations-qr/:id',
  REST_CHARGING_STATION_CONNECTOR = 'charging-stations/:id/connectors/:connectorId',
  ...
  REST_CHARGING_STATION_TRIGGER_SMART_CHARGING_BY_TARIF = 'charging-stations/smartchargingtarif/trigger',
  REST_CHARGING_STATION_CONNECTOR_USER = 'charging-stations/:id/connectors/:connectorId/owners',
  ...
  REST_TRANSACTION_QR = 'transactions-qr/:id',
  ...
  REST_TRANSACTION_STOP_QR = 'transactions-qr/:id/stop',
  ...
  REST_USERS = 'users',
  REST_USERS_EMAIL = 'users-email',
  REST_USER = 'users/:id',
  REST_USER_QR = 'users-qr/:id',
  REST_USERS_QR = 'users-qr',
  ...
  REST_TAGS_EMSP = 'tags/emsp/credentials',

  REST_EMAIDS = 'emaids',
  REST_EMAID = 'emaids/:id',
  REST_EMAID_ASSIGN = 'emaids/:id/assign',
  REST_EMAID_UNASSIGN = 'emaids/:id/unassign',
  REST_EMAIDS_UNASSIGN = 'emaids/unassign',
  REST_EMAIDS_IMPORT = 'emaids/action/import',
  REST_EMAIDS_EXPORT = 'emaids/action/export',
  ...
  REST_TENANTS_LIST = 'tenants/list',
  REST_TENANT = 'tenants/:id',
  REST_TENANT_DATA = 'tenants/:id/data',
  REST_TENANT_OCPI = 'tenants/ocpi/:id',
  REST_TENANT_MULTIPLE_TARIFS = 'tenants/multiple-tarifs/:id',
  REST_TENANT_LOGO = 'tenants/logo',
  REST_TENANT_EMAIL_LOGO = 'tenants/email-logo',
  REST_TENANT_FAVICON = 'tenants/favicon',
  REST_TENANT_COLORS = 'tenants/colors',

  REST_COMPANIES = 'companies',
  REST_COMPANY = 'companies/:id',
  REST_COMPANY_LOGO = 'companies/:id/logo',
  REST_COMPANY_FAVICON = 'companies/:id/favicon',
  REST_COMPANY_COLORS = 'companies/:id/colors',
  ...
  REST_OCPI_ENDPOINT_PULL_INTERRUPTED_TOKENS = 'ocpi/endpoints/:id/tokens/pull-tokens',
  REST_OCPI_ENDPOINT_PULL_TOKENS_WITH_OFFSET = 'ocpi/endpoints/:id/tokens/pull/:offset',
  REST_OCPI_ENDPOINT_SEND_EVSE_STATUSES = 'ocpi/endpoints/:id/evses/statuses/send',
  REST_OCPI_ENDPOINT_PATCH_LOCATIONS = 'ocpi/endpoints/:id/evses/send',
  ...
  REST_OCPI_ENDPOINT_DEFAULT = 'ocpi/endpoints/:id/default',
  ...
  REST_DASHBOARD_STATISTICS = 'statistics/dashboard',
  ...
  REST_BILLING_SETTING_QR = 'billing-setting-qr',// GET and PUT
  ...
  REST_PRICING_DEFINITIONS_QR = 'pricing-definitions-qrcode',

  // PRICING URLs for Non-CRUD operations
  REST_PRICING_MODEL_RESOLVE = 'pricing-model/resolve',
  EDIT_REMOTE_PRICING = 'remote-pricing',
  // REST_CERTIFICATE = "REST_CERTIFICATE",
  // REST_CERTIFICATES = "REST_CERTIFICATES",

  REST_CERTIFICATES = 'certificates',
  REST_CERTIFICATE = 'certificates/:id',
  REST_CERTIFICATE_ASSIGN = 'certificates/:id/assign',
  REST_CERTIFICATE_UNASSIGN = 'certificates/:id/unassign',
  REST_CERTIFICATES_UNASSIGN = 'certificates/unassign',
