...
export enum HTTPError {
  ...
  MISSING_SUBDOMAIN_PARAMETER = 562,
  TENANT_NOT_FOUND = 563,
  ...
  TAG_EMSP_DOESNT_BELONG_TO_ORGANISATION_ERROR = 574,
  TAG_EMSP_DOESNT_EXIST_ERROR = 575,
  TAG_ALREADY_EXIST_ERROR = 576,
  TAG_VISUAL_ID_ALREADY_EXIST_ERROR = 577,
  TAG_VISUAL_ID_DOES_NOT_MATCH_TAG_ERROR = 578,
  TAG_INACTIVE = 579,

  EMAID_EMSP_DOESNT_BELONG_TO_ORGANISATION_ERROR = 574,
  EMAID_EMSP_DOESNT_EXIST_ERROR = 575,
  EMAID_ALREADY_EXIST_ERROR = 576,
  EMAID_VISUAL_ID_ALREADY_EXIST_ERROR = 577,
  EMAID_VISUAL_ID_DOES_NOT_MATCH_EMAID_ERROR = 578,
  EMAID_INACTIVE = 579,
  ...
  CERTIFICATE_ID_DOES_NOT_MATCH_CERTIFICATE_ERROR,
  FILE_TOO_LARGE,
}
