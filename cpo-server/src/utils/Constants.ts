...
export const DATABASE_COLLECTION_CERTIFICATES = 'certificates';
export default class Constants {
  ...
  public static readonly PERF_MAX_RESPONSE_TIME_MILLIS = 5000;
  ...
  public static readonly TENANT_DEFAULT_FAVICON = '/assets/img/favicon.png';
  ...
  public static readonly OCPP_SOCKET_TIMEOUT_MILLIS = 60 * 1000;
  ...
  /* App Info for STRIPE */
  public static readonly STRIPE_APP_NAME = 'wattzhub';
