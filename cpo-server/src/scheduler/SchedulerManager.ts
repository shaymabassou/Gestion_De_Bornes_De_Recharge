...
import OCPIFullPullTokensTask from './tasks/ocpi/OCPIFullPullTokensTask';
import BillUnpaidTransactionTask from './tasks/BillUnpaidTransactionTask';
...
export default class SchedulerManager {
  ...
  private static async createTask(name: string): Promise<SchedulerTask> {
    ...
    switch (name) {
      ...
      case 'OCPIFullPullTokensTask':
        return new OCPIFullPullTokensTask();
      ...
      case 'BillUnpaidTransactionTask':
        return new BillUnpaidTransactionTask();
